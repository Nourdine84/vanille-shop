      ...
      <section style={hero}>
        ...
        <div style={content}>
          ...
          <p style={text}>
            ...
            confirmée et notre équipe
            prépare actuellement votre
            sélection premium.
          </p>

          <p style={subText}>
            Un email récapitulatif vous
            a été envoyé.
          </p>
          ...
          <p style={signature}>
            VanilleOr — L’excellence de
            la vanille et des épices de
            Madagascar
          </p>
        </div>
      </section>
